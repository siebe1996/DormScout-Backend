...
namespace Backend_DormScout.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private void SetTokenCookie(string token)
        {
            ...
            Response.Cookies.Append("Backend_DormScout.RefreshToken", token, cookieOptions);
        }
        ...
        public async Task<ActionResult<PostAuthenticateResponseModel>> RenewToken()
        {
            try
            {
                string refreshToken = Request.Cookies["Backend_DormScout.RefreshToken"];
        ...
        public async Task<IActionResult> DeactivateToken(PostDeactivateTokenRequestModel postDeactivateTokenRequestModel)
        {
            try
            {
                ...
                string token = postDeactivateTokenRequestModel.Token ?? Request.Cookies["Backend_DormScout.RefreshToken"];
